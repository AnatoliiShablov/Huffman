...
huffman_zipper::huffman_zipper() : buffer_char(0), buffer_position(7), last(false), amount_of_bytes(0) {
...
void huffman_zipper::code(unsigned char const *words, size_t length, std::vector<unsigned char> &encoded) {
